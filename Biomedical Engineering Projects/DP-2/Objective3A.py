...
# Subprogram 2 variables
cyclesFail = 10
stressFail = 10
def subprogram_two():
    print (f"cyclesFail = {cyclesFail} \nstressFail = {stressFail}")
...
def main ():
    ...
    if (user_input == "1"):
        ...
        print ("LOL, you wish you could break this program. Try again and this time, input an integer value between 1-4 based of what you want to accomplish.")
